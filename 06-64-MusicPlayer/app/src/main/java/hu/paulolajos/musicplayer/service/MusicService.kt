package hu.paulolajos.musicplayer.service
...
class MusicService : Service(), AudioManager.OnAudioFocusChangeListener {
    ...
    fun showNotification(playPauseButton: Int) {
        ...
        val prevIntent =
            Intent(baseContext, MusicBroadcastReceiver::class.java).setAction(ApplicationClass.PREVIOUS)
        ...
        val playIntent =
            Intent(baseContext, MusicBroadcastReceiver::class.java).setAction(ApplicationClass.PLAY)
        ...
        val nextIntent =
            Intent(baseContext, MusicBroadcastReceiver::class.java).setAction(ApplicationClass.NEXT)
        ...
        val exitIntent =
            Intent(baseContext, MusicBroadcastReceiver::class.java).setAction(ApplicationClass.EXIT)
                                ...
                                KeyEvent.KEYCODE_MEDIA_PAUSE -> {
                                    if (mediaPlayer != null) {
                                        if (MusicInterface.isPlaying) {
                                            ...
                                            NowPlayingFragment.binding.fragmentButton.setImageResource(
